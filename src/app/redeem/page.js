...
export default function RedeemPage() {
  return (
    <div className="min-h-screen w-full bg-background font-poppins relative">
      ...
      <main className="relative z-10 w-full min-h-screen flex items-center justify-center p-3 md:p-6 py-8">
        {/* Redeem Card */}
        <div
          id="redeem-card"
          style={{
        ...
        >
          ...
          <div style={{ marginBottom: '6px', display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '14px', color: '#888', fontWeight: 'bold', fontFamily:'Sigmar' }}>Redeem Fee</span>
            <span style={{ fontSize: '14px', fontWeight: 'bold', fontFamily:'Sigmar', color:'#000' }}>0.3 %</span>
          </div>
          <div style={{ marginBottom: '6px', display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '14px', color: '#888', fontWeight: 'bold', fontFamily:'Sigmar' }}>Pool Balance</span>
            <span style={{ fontSize: '14px', fontWeight: 'bold', fontFamily:'Sigmar', color:'#000' }}>0.02074854 WETH</span>
          </div>
          <div style={{ marginBottom: '14px', display: 'flex', justifyContent: 'space-between' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 'bold', fontFamily:'Sigmar', color:'#000' }}>0.0 WETH</span>
          </div>
